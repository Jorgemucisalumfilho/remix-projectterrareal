...
criar criptomoeda
Valeterra
[![CircleCI](https://img.shields.io/circleci/build/github/ethereum/remix-project? criar token terrareal logo=circleci) React from 'react'
import ReactDOM from 'react-dom'
import App from './app/app'

ReactDOM.render(
  <App />,
  document.getElementById('https://github.com/Jorgemucisalumfilho/remix-projectterrareal')
)