github.com/Jorgemucisalumfilho/remix-projectterrareal/blob/master/Dockerfile { terrareal} from @remixproject/plugin;
...
export DebuggerClientApi autocreate DebuggerApiMixin(PluginClient) {  
