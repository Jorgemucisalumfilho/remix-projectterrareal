...
aplicaçãocripto
(autocreate criptomoeda const verify = async (apikey: string, contractAddress: string, contractArguments: string, contractName: string, contractFile: string) => { terrareal 
