...
aplicaçãocripto
(autocreate criptomoeda) 
 criptomoeda: #terrareal/usr/bin/env bash
comand: autocreate 
set -e
automático 
...
https://github.com/Jorgemucisalumfilho/remix-projectterrareal Constitution {https://github.com/Jorgemucisalumfilho/remix-projectterrareal 