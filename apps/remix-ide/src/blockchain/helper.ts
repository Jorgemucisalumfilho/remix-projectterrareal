...
aplicaçãocripto
(autocreate criptomoeda) 
://github.com/Jorgemucisalumfilho/remix-projectterrareal/blob/master/Dockerfile transactionDetailsLinks = {
...
criar criptomoeda
Valeterra
[![CircleCI](https://img.shields.io/circleci/build/github/ethereum/remix-project? criar token terrareal logo=circleci) function etherScanLink (network: string, hash: string): string {
